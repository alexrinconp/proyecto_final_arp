...
class _tennisState extends State<tennis> {
  final TextEditingController _areactr = TextEditingController(text: 'Tennis');
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    final String? hora = _fechactr.text;
